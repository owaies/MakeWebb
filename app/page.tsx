...
export default function Home(){
  ...
  return <main>
    ...
    <section className="contact-section shell" id="contact"><div className="contact-card"><div className="contact-orb"><Code2 size={42}/><span/></div><div className="contact-copy"><span className="section-number">04 / CONTACT</span><h2>Have an idea?<br/><em>Let's make it real.</em></h2><p>Tell us what you are building. We will figure out the best shape for it.</p></div><div className="contact-actions"><div style={{display:'flex',flexDirection:'column',gap:'10px',width:'100%',maxWidth:'330px'}}><a href="mailto:owaies786@gmail.com" aria-label="Contact Mohammed Owaies by email" style={{display:'flex',alignItems:'center',justifyContent:'space-between',gap:'12px',width:'100%',padding:'14px 16px',border:'1px solid var(--line)',borderRadius:'100px',background:'rgba(255,255,255,.025)',color:'var(--text)',fontSize:'12px',fontWeight:800}}><span>Mohammed Owaies</span><Mail size={16}/></a><a href="mailto:kingahassan786@gmail.com" aria-label="Contact Mohammed Afaf Hassan by email" style={{display:'flex',alignItems:'center',justifyContent:'space-between',gap:'12px',width:'100%',padding:'14px 16px',border:'1px solid var(--line)',borderRadius:'100px',background:'rgba(255,255,255,.025)',color:'var(--text)',fontSize:'12px',fontWeight:800}}><span>Mohammed Afaf Hassan</span><Mail size={16}/></a></div><a className="button primary" href="mailto:owaies786@gmail.com">Start with email <Mail size={17}/></a><a className="contact-detail" href="tel:+917619329863"><Phone size={16}/> +91 76193 29863</a><a className="contact-detail" href="mailto:kingahassan786@gmail.com"><Mail size={16}/> kingahassan786@gmail.com</a></div></div></section>
