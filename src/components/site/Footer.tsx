        ...
        <div className="grid gap-12 md:grid-cols-[1.4fr_1fr_1fr]">
          <div>
            ...
            <a
              ...
              className="mt-5 inline-block text-sm underline-offset-4 hover:underline"
            >
              {company.email}
            </a>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              ...
              {founders.map((f) => (
                <li key={f.name}><a href={f.linkedin} target="_blank" rel="noreferrer" className="hover:text-primary">{f.name.split(" ").slice(-1)} · LinkedIn</a></li>
              ))}
            </ul>
          </div>
        </div>
