...
function Hero() {
  return (
    <section className="makewebb-hero relative min-h-[100svh] overflow-hidden">
      <div className="makewebb-hero-wash" />
      <div className="relative z-10 mx-auto min-h-[100svh] max-w-[1440px] px-6 pb-14 pt-28 md:px-10 md:pt-32 lg:px-10">
        <div className="grid min-h-[calc(100svh-7rem)] grid-cols-12">
          <div className="col-span-12 flex flex-col justify-center lg:col-span-5 lg:justify-start lg:pt-[9vh]">
          ...
          <div className="pointer-events-none absolute inset-x-0 top-0 hidden h-full lg:block"><div className="makewebb-hero-character-label"><span>う</span><span>ち</span><span>は</span><span>サ</span><span>ス</span><span>ケ</span></div></div>
...
function Home(){return <main><div className="hero-services-stage"><RinneganBackground/><div className="hero-model-sticky"><HeroModel/></div><Hero/><Marquee/><Services/></div><ScrollStory/><WorkPreview/><CTA/></main>}
